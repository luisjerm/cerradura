/**
 * MFRC522.h - Modification of the library to use ARDUINO RFID MODULE KIT 13.56 MHZ WITH TAGS SPI W AND R BY COOQROBOT
 * to be used in C. 
 ...
 * Ported to C by Julio Pastor (Department of Electronics - University of Alcala) 2016.
 *
...
extern   const uint8_t FIFO_SIZE;   // The FIFO is 64 bytes.
